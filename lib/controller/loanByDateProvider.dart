...
class LoanByDateProvider extends ChangeNotifier {
  final LoanByDateService _loanByDateService = LoanByDateService();
  ...
  Future<void> getDailySavings(String agentID, String date) async {
    ...
    notifyListeners();
    final response =
    await _loanByDateService.getSavingsByDate(agentID, date);
